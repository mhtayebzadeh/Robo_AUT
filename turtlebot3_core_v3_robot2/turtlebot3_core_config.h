 ...
 * Servo object
 **************/
Servo cameraPosTiltServo;
Servo cameraPosPanServo;
Servo gripperServoLeft;
Servo gripperServoRight;
...
ros::Subscriber<std_msgs::Int32> camera_pos_tilt_sub("camera_pos_tilt", cameraPosTiltCallback);

ros::Subscriber<std_msgs::Int32> camera_pos_pan_sub("camera_pos_pan", cameraPosPanCallback);

ros::Subscriber<std_msgs::Int32> gripper_sub("gripper_pos", gripperCallback);
